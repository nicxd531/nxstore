...
import homeAndOutDoor from "../../data/homeAndOutDoor.json";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography
            sx={{ fontWeight: "bold", fontSize: "1.4rem", width: "60%" }}
          >
            {" "}
            Home and outdoor
          </Typography>
      ...
      >
        {homeAndOutDoor.map((data, index) => {
          return (
            ...
            >
              <Box
                sx={{ width: { xs: "100%", lg: "70%" }, mt: { xs: 1, lg: 0 } }}
              >
                <Typography
                  sx={{
                    fontWeight: "bold",
